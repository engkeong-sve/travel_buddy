...
root_agent = Agent(
    ...
    tools=[
        AgentTool(hotel_agent, skip_summarization=True),
        AgentTool(flight_agent, skip_summarization=True),
        AgentTool(attraction_spot_agent, skip_summarization=True),
        AgentTool(restaurant_agent, skip_summarization=True),
        AgentTool(routing_agent, skip_summarization=True),
